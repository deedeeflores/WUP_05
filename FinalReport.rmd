...
The P value is .0000001242 from the Chisq test shows that the vaccine is effective in preventing aids among drug users.The fisher exact test shows P value to be.00000423 which makes us reject the null hypothesis.the odds ratio of getting aids is 0.35 times likely than someone who is getting the placebo. the answer still the same.
